...
import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaYoutube, FaGlobe } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul>
              ...
              <li className="mb-2 py-2"><a href="#"></a>Ideation</li>
              <li className="mb-2 py-2"><a href="#"></a>Wireframing</li>
              <li className="mb-2 py-2"><a href="#"></a>Research</li>
              <li className="mb-2 py-2"><a href="#"></a>Design</li>
            </ul>
          </div>
          {/* Third Column */}
          <div>
          ...
          <div>
            ...
            <div className="mb-14">
              <img src="./src/assets/img/footer/AppStore.png" alt="App Store" className="w-[120px] h-auto mr-4 mb-2"/>
              <img src="./src/assets/img/footer/GooglePlay.png" alt="Google Play" className="w-[135px] h-auto"/>
            </div>
